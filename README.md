...
You can then execute your native executable with: `./target/camel-jms-app-1.0.0-SNAPSHOT-runner`

If you want to learn more about building native executables, please consult <https://quarkus.io/guides/maven-tooling>.

## Related Guides

- AMQP 1.0 JMS client - Apache Qpid JMS ([guide](https://quarkus.io/guides/jms)): Use JMS APIs with AMQP 1.0 servers such as Apache Artemis, Apache ActiveMQ, Apache Qpid Broker-J, Azure Service Bus, and more
